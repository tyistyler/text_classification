...
if __name__ == '__main__':
    ...
    parser.add_argument("--cat", default="cat", type=str, help="different cat methods")
    parser.add_argument("--cnn_dropout", default="0.3", type=float, help="different cat methods")
    parser.add_argument("--kernel", default="linear", type=str,  choices=['linear', 'poly', 'rbf', 'sigmoid', 'precomputed'],help="different cat methods")

    parser.add_argument("--model_type", default="bert", type=str, help="Model type selected in the list: " + ", ".join(MODEL_CLASSES.keys()))
    parser.add_argument('--seed', type=int, default=66, help="random seed for initialization")
    parser.add_argument("--batch_size", default=64, type=int, help="Batch size for training and evaluation.")#batch_size=16
    parser.add_argument("--max_seq_len", default=30, type=int, help="The maximum total input sequence length after tokenization.")
    ...
    parser.add_argument("--cls_dropout", default=0.1, type=float, help="Dropout for fully-connected layers")

    parser.add_argument('--logging_steps', type=int, default=22, help="Log every X updates steps.")
    parser.add_argument('--save_steps', type=int, default=22, help="Save checkpoint every X updates steps.")

    parser.add_argument("--do_train", action="store_true", help="Whether to run training.")
    parser.add_argument("--do_eval", action="store_true", help="Whether to run eval on the test set.")
    parser.add_argument("--no_cuda", action="store_true", help="Avoid using CUDA when available")
    parser.add_argument("--use_cnn", action="store_true", help="Whether to use cnn.")
    parser.add_argument("--use_svm", action="store_true", help="Whether to use svm.")
    ...
    args.model_dir = "ckpt/{}_{}_{}.pth".format(args.model_type, args.task, print_time())
